<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_MasterPage.master" AutoEventWireup="true" CodeFile="dvideo.aspx.cs" Inherits="admin_dvideo" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <asp:Button ID="videobtn" runat="server" Text="Search" class="btn btn-info" ValidationGroup="v1" OnClick="videobtn_Click"/>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="panel-body">
                          <div class="form-group">
                              <label class="col-sm-3 control-label"></label>
                        <asp:GridView ID="postgv5" runat="server" Width="500px" AutoGenerateColumns="false" AllowPaging="true" PageSize="5" OnPageIndexChanging="postgv5_PageIndexChanging" OnRowCommand="postgv5_RowCommand" OnRowDataBound="postgv5_RowDataBound" OnRowCreated="postgv5_RowCreated">
                          <HeaderStyle Height="5px" Font-Size="14px" BackColor="#666666" BorderColor="#000000" ForeColor="White" />
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField>
                                  <ItemTemplate>
                                      <asp:LinkButton ID="linkedit4" runat="server" Text="Delete" CommandName="delete5" CommandArgument='<%#Bind("id")%>' OnClientClick="return confirm('Are you sure you want Delete')">
                                      </asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                                <asp:TemplateField>
