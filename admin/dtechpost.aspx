<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_MasterPage.master" AutoEventWireup="true" CodeFile="dtechpost.aspx.cs" Inherits="admin_dtechpost" %>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <asp:Button ID="postbtn" runat="server" Text="Search" class="btn btn-info" ValidationGroup="v1" OnClick="postbtn_Click"/>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="panel-body">
                              <div class="form-group">
                               <label class="col-sm-3 control-label"></label> 
                        <asp:GridView ID="postgv1" runat="server" Width="500" AutoGenerateColumns="false" AllowPaging="true" PageSize="5" OnPageIndexChanging="postgv1_PageIndexChanging" OnRowCommand="postgv1_RowCommand" OnRowDataBound="postgv1_RowDataBound" OnRowCreated="postgv1_RowCreated">
                           <HeaderStyle Height="5px" Font-Size="14px" BackColor="#666666" BorderColor="#000000" ForeColor="White" />
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField>
                                  <ItemTemplate>
                                      <asp:LinkButton ID="linkedit" runat="server" Text="Delete" CommandName="delete1" CommandArgument='<%# Bind("id") %>' OnClientClick="return confirm('Are you sure you want Delete')">
                                      </asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                          </Columns>
